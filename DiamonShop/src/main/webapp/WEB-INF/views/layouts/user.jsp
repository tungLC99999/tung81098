		...
		<div class="topNav">
			<div class="container">
				<div class="alignR">
					...
					<a href="<c:url value="/infor"/>">
					<span class="icon-user"></span> ${ LoginInfo.username } </a>									
					...
					<a href="<c:url value="/gio-hang"/>"><span	class="icon-shopping-cart"></span> ${ TotalQuantyCart } Sản Phẩm - <span
...
-->
	...
	<a href="#" class="gotop"><i class="icon-double-angle-up" aria-hidden="true"></i></a>
