							...
							<div class="control-group">
								...
								<div class="controls">
									<form:input type="text" class="span3"
										placeholder="Mời nhập Họ và tên" path="address" />
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<form:input type="text" class="span3"
										placeholder="Mời nhập địa chỉ" path="display_name" />
								</div>
							</div>
					...
					<div class="well">
						...
						<form:form action="dang-nhap" method="POST" modelAttribute="user">
							...
							<div class="control-group">
								<label class="control-label" for="inputEmail">Email</label>
								<div class="controls">
									<form:input type="email" class="span3" placeholder="Email" path="username" />
