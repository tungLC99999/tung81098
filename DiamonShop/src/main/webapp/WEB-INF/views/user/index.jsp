	...
	<div class="row">
		<div id="sidebar" class="span3">
			<div class="well well-small">
				<ul class="nav nav-list">
					...
					<li><a class="totalInCart" href="gio-hang"><strong>Đã
						...
						class="badge badge-warning"><fmt:formatNumber type="number" groupingUsed="true" value="${ TotalPriceCart }" />	 ₫</strong></span>
						</strong></a></li>
				</ul>
			</div>
			...
			<ul class="nav nav-list promowrapper">
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href='<c:url value="/san-pham/1"/>'
						...
						<div class="caption">
							<h4>
								<a class="defaultBtn" href='<c:url value="/san-pham/1"/>'>VIEW</a> <span
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href='<c:url value="/san-pham/2"/>'
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img
						...
						<div class="caption">
							<h4>
								<a class="defaultBtn" href='<c:url value="/san-pham/2"/>'>VIEW</a> <span
									class="pull-right">$22.00</span>
							</h4>
						</div>
					</div>
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href='<c:url value="/san-pham/3"/>'
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img
						...
						<div class="caption">
							<h4>
								<a class="defaultBtn" href='<c:url value="/san-pham/3"/>'>VIEW</a> <span
									class="pull-right">$22.00</span>
							</h4>
						</div>
					</div>
										...
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="product_details.html"
													...
													href="chi-tiet-san-pham/${ item.id_product }"><img src="<c:url value="/assets/user/img/${ item.img }"/>" alt=""
													alt=""></a>
											</div>
										</li>
										<c:if
